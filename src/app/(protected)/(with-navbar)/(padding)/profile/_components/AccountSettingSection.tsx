      ...
      <div className="border border-border rounded-3xl flex flex-col">
        {PROFILE_SETTING_ITEMS.map((item) => (
          <Link key={item.id} href={item.link}>
            <div className="flex flex-row justify-start items-center gap-4 cursor-pointer active:bg-muted active:scale-[97%] transition-all duration-100 ease-out p-5 rounded-3xl lg:hover:bg-muted">
