...
function StepperIndicator({
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "border-background bg-input text-accent-foreground data-[state=completed]:bg-accent data-[state=completed]:text-accent-foreground data-[state=active]:bg-accent data-[state=active]:text-accent-foreground relative flex size-8 shrink-0 items-center justify-center overflow-hidden",
...
function StepperSeparator({ className }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "bg-input rounded-full m-0.5 group-data-[orientation=horizontal]/stepper-nav:h-1 group-data-[orientation=horizontal]/stepper-nav:flex-1 group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5",
        "group-data-[state=completed]/step:bg-accent absolute inset-x-0 top-4 right-[calc(50%+0.875rem)] m-0 group-data-[orientation=horizontal]/stepper-nav:w-[calc(100%-2rem+0.225rem)] group-data-[orientation=horizontal]/stepper-nav:flex-none" ,
        className
      )}
    />
  )
